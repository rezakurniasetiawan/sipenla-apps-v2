...
class ListWeekEkstraStudent extends StatefulWidget {
  const ListWeekEkstraStudent({Key? key}) : super(key: key);

  @override
  State<ListWeekEkstraStudent> createState() => _ListWeekEkstraStudentState();
}

class _ListWeekEkstraStudentState extends State<ListWeekEkstraStudent> {
  double value = 50;
  ...
  Future<void> fungsiGetWeekAbsensi() async {
    ApiResponse response = await getWeekAbsensiEsktra();
