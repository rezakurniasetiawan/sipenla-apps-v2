...
class DetailRekapRiwayatBayarKantin extends StatefulWidget {
  const DetailRekapRiwayatBayarKantin({Key? key}) : super(key: key);

  @override
  State<DetailRekapRiwayatBayarKantin> createState() =>
      _DetailRekapRiwayatBayarKantinState();
}

class _DetailRekapRiwayatBayarKantinState
    extends State<DetailRekapRiwayatBayarKantin> {
          ...
          children: [
            ...
            Column(
              children: [
                ...
                TextParagraf(title: 'Nominal SPP', value: 'Lorem Ipsum'),
                Container(
                  height: 1,
