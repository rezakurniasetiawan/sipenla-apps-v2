...
class DetailRiwayatBayarKantin extends StatefulWidget {
  const DetailRiwayatBayarKantin({Key? key}) : super(key: key);

  @override
  State<DetailRiwayatBayarKantin> createState() =>
      _DetailRiwayatBayarKantinState();
}

class _DetailRiwayatBayarKantinState extends State<DetailRiwayatBayarKantin> {
  @override
