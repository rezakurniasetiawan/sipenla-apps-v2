...
class DetailRekapRiwayatDenda extends StatefulWidget {
  const DetailRekapRiwayatDenda({Key? key}) : super(key: key);

  @override
  State<DetailRekapRiwayatDenda> createState() =>
      _DetailRekapRiwayatDendaState();
}

class _DetailRekapRiwayatDendaState extends State<DetailRekapRiwayatDenda> {
          ...
          children: [
            ...
            Column(
              children: [
                ...
                TextParagraf(title: 'Kode', value: 'Lorem Ipsum'),
                TextParagraf(title: 'Tanggal', value: 'Lorem Ipsum'),
                TextParagraf(title: 'Waktu', value: 'Lorem Ipsum'),
                TextParagraf(title: 'Nominal Denda', value: 'Lorem Ipsum'),
                Container(
                  height: 1,
