...
import 'package:siakad_app/models/laporan_keuangan_models.dart';
import 'package:siakad_app/widget/laporan-keuangan/denda-page/riwayat-denda/detail_riwayat_denda.dart';
...
class RiwayatDenda extends StatefulWidget {
  const RiwayatDenda({Key? key}) : super(key: key);

  @override
  State<RiwayatDenda> createState() => _RiwayatDendaState();
}

class _RiwayatDendaState extends State<RiwayatDenda> {
  ...
  Future<void> fungsigetHistoryUser() async {
    ApiResponse response = await getRiwayatDendaUser(tanggal: tanggal.text);
            ...
            Expanded(
              child: ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    ...
                    return ItemRiwayatSpp(
                      code: riwayatDendaUser.fineTransactionCode,
                      date: riwayatDendaUser.createdAt.day.toString() +
                          '-' +
                          riwayatDendaUser.createdAt.month.toString() +
                          '-' +
                          riwayatDendaUser.createdAt.year.toString(),
                      ontaps: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => DetailRiwayatDenda(
                                      riwayatDendaUser: riwayatDendaUser,
                                    )));
                      },
...
class ItemRiwayatSpp extends StatelessWidget {
  const ItemRiwayatSpp({
    Key? key,
