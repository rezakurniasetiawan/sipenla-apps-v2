...
import 'package:siakad_app/services/laporan_keuangan_service.dart';
...
class _TarikSaldoState extends State<TarikSaldo> {
  ...
  void fungsipayoutService({required String inputBalance}) async {
    showAlertDialog(context);
    ApiResponse response = await payoutService(balance: inputBalance);
    if (response.error == null) {
      setState(() {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(content: Text('Berhasil Melakukan Tarik Saldo')));
      });
