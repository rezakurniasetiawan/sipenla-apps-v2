...
class DetailRiwayatSpp extends StatefulWidget {
  const DetailRiwayatSpp(
  ...
  @override
  State<DetailRiwayatSpp> createState() => _DetailRiwayatSppState();
}

class _DetailRiwayatSppState extends State<DetailRiwayatSpp> {
  @override
