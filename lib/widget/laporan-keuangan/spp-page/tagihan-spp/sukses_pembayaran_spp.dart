...
class SuksesPembayaranSpp extends StatefulWidget {
  const SuksesPembayaranSpp(
  ...
  @override
  State<SuksesPembayaranSpp> createState() => _SuksesPembayaranSppState();
}

class _SuksesPembayaranSppState extends State<SuksesPembayaranSpp> {
  String kondisi = '';
