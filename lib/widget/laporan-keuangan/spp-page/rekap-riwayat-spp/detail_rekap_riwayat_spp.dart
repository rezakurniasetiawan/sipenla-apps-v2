...
class DetailRekapRiwayatSpp extends StatefulWidget {
  const DetailRekapRiwayatSpp({Key? key}) : super(key: key);

  @override
  State<DetailRekapRiwayatSpp> createState() => _DetailRekapRiwayatSppState();
}

class _DetailRekapRiwayatSppState extends State<DetailRekapRiwayatSpp> {
