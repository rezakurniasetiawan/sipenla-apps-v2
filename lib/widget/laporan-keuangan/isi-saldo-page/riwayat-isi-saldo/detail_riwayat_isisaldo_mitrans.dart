...
class DetailRiwayatIsiSaldoMitrans extends StatefulWidget {
  const DetailRiwayatIsiSaldoMitrans(
      {Key? key,
      required this.code,
  ...
  @override
  State<DetailRiwayatIsiSaldoMitrans> createState() =>
      _DetailRiwayatIsiSaldoMitransState();
}

class _DetailRiwayatIsiSaldoMitransState
    extends State<DetailRiwayatIsiSaldoMitrans> {
  @override
