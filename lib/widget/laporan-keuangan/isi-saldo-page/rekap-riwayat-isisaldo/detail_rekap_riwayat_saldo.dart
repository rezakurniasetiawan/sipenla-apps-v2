...
class DetailRekapRiwayatSaldo extends StatefulWidget {
  const DetailRekapRiwayatSaldo({Key? key}) : super(key: key);

  @override
  State<DetailRekapRiwayatSaldo> createState() =>
      _DetailRekapRiwayatSaldoState();
}

class _DetailRekapRiwayatSaldoState extends State<DetailRekapRiwayatSaldo> {
          ...
          children: [
            ...
            Column(
              children: [
                ...
                TextParagraf(title: 'Nominal Isi Saldo', value: 'Lorem Ipsum'),
                Container(
                  height: 1,
