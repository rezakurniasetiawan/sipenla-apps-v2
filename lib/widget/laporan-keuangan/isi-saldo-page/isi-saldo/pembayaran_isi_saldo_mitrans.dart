...
import 'package:siakad_app/widget/laporan-keuangan/isi-saldo-page/isi-saldo/sukses_mitrans.dart';
...
class PembayaranIsiSaldoMitrans extends StatefulWidget {
  const PembayaranIsiSaldoMitrans(
      {Key? key,
      required this.oderId,
      required this.vaNumber,
      required this.valuTopup})
      : super(key: key);

  final String oderId, vaNumber, valuTopup;

  @override
  State<PembayaranIsiSaldoMitrans> createState() =>
      _PembayaranIsiSaldoMitransState();
}

class _PembayaranIsiSaldoMitransState extends State<PembayaranIsiSaldoMitrans> {
  Timer? timer;
  String status = '';
    ...
    if (response.statusCode == 200) {
      ...
      if (belum == '201') {
        ...
        Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => SuksesMitrans(
                      orderId: widget.oderId,
                      valueTopup: widget.valuTopup,
                    )));
      }
    } else {
