...
class RiwayatKonfirmasiTabungan extends StatefulWidget {
  const RiwayatKonfirmasiTabungan({Key? key}) : super(key: key);

  @override
  State<RiwayatKonfirmasiTabungan> createState() =>
      _RiwayatKonfirmasiTabunganState();
}

class _RiwayatKonfirmasiTabunganState extends State<RiwayatKonfirmasiTabungan> {
  ...
  Future<void> fungsigetApproveTarikTabunganSiswa() async {
    ApiResponse response =
        await getKonfirmasiTarikTabunganSiswa(tanggal: tanggal.text);
  ...
  Future<void> fungsigetApproveTarikTabunganPegawai() async {
    ApiResponse response =
        await getKonfirmasiTarikTabunganPegawai(tanggal: tanggal.text);
    if (response.error == null) {
      setState(() {
        aprroveTarikSaldoSiswaList = response.data as List<dynamic>;
        _loading = _loading ? !_loading : _loading;
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    ...
                    return Column(
                      children: [
                        TextParagraf(
                            title: 'Nama',
                            value: konfirmasiTarikSaldoSiswaModel.firstName +
                                ' ' +
                                konfirmasiTarikSaldoSiswaModel.lastName),
                        TextParagraf(
                            title: 'Kode Transaksi',
                            value: konfirmasiTarikSaldoSiswaModel.savingCode),
                        TextParagraf(title: 'Tanggal', value: tanggal),
                        TextParagraf(
                            title: 'Waktu',
                            value: konfirmasiTarikSaldoSiswaModel.waktu),
                        TextParagraf(
