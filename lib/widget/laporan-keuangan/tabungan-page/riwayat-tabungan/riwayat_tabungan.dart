...
class RiwayatTabungan extends StatefulWidget {
  const RiwayatTabungan({Key? key}) : super(key: key);

  @override
  State<RiwayatTabungan> createState() => _RiwayatTabunganState();
}
...
class _RiwayatTabunganState extends State<RiwayatTabungan> {
  ...
  Future<void> fungsiriwayatIsiTabungan() async {
    ApiResponse response = await riwayatIsiTabungan(tanggal: tanggal.text);
