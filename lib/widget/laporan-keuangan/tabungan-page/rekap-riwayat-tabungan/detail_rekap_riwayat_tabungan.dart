...
class DetailRekapRiwayatTabungan extends StatefulWidget {
  const DetailRekapRiwayatTabungan({Key? key}) : super(key: key);

  @override
  State<DetailRekapRiwayatTabungan> createState() =>
      _DetailRekapRiwayatTabunganState();
}

class _DetailRekapRiwayatTabunganState
    extends State<DetailRekapRiwayatTabungan> {
          ...
          children: [
            ...
            Column(
              children: [
                ...
                TextParagraf(title: 'Nominal Pencairan', value: 'Lorem Ipsum'),
                Container(
                  height: 1,
