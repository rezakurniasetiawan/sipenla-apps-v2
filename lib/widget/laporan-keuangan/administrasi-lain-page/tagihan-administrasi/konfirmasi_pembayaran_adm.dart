...
import 'package:siakad_app/widget/laporan-keuangan/administrasi-lain-page/tagihan-administrasi/pembayaran_adm.dart';
...
class KonfirmasiPembayaranAdm extends StatefulWidget {
  const KonfirmasiPembayaranAdm(
      {Key? key,
      required this.total,
  ...
  final String total;
  final String todate, bulan;

  @override
  State<KonfirmasiPembayaranAdm> createState() =>
      _KonfirmasiPembayaranAdmState();
}

class _KonfirmasiPembayaranAdmState extends State<KonfirmasiPembayaranAdm> {
            ...
            Expanded(
              child: Column(
                children: [
                  const Center(
                    child: Text(
                      'Tagihan Administrasi Lain - Lain',
                      style: TextStyle(
                        fontSize: 20,
                        color: Color(0xff4B556B),
                        fontFamily: 'Poppins',
