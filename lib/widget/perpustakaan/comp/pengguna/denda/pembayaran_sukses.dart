...
class PembayaranSuksesDenda extends StatefulWidget {
  const PembayaranSuksesDenda({Key? key, required this.pemabayaranDendaModel})
      : super(key: key);

  final PemabayaranDendaModel pemabayaranDendaModel;

  @override
  State<PembayaranSuksesDenda> createState() => _PembayaranSuksesDendaState();
}

class _PembayaranSuksesDendaState extends State<PembayaranSuksesDenda> {
  int balanceku = 0;
