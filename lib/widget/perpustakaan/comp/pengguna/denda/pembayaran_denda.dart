...
class PembayaranDenda extends StatefulWidget {
  const PembayaranDenda(
  ...
  @override
  State<PembayaranDenda> createState() => _PembayaranDendaState();
}

class _PembayaranDendaState extends State<PembayaranDenda> {
  int balanceku = 0;
