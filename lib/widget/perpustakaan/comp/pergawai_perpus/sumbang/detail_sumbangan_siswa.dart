...
class DetailSumbanganSiswa extends StatefulWidget {
  const DetailSumbanganSiswa({Key? key, required this.sumbanganSiswaModel})
      : super(key: key);

  final SumbanganSiswaModel sumbanganSiswaModel;

  @override
  State<DetailSumbanganSiswa> createState() => _DetailSumbanganSiswaState();
}

class _DetailSumbanganSiswaState extends State<DetailSumbanganSiswa> {
            ...
            Expanded(
              child: Column(
                children: [
                  Center(
                    child: Container(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: widget.sumbanganSiswaModel.image,
                        fit: BoxFit.cover,
                  ...
                  TextParagraf(
                      title: 'Nama',
                      value: widget.sumbanganSiswaModel.firstName +
                          ' ' +
                          widget.sumbanganSiswaModel.lastName),
                  TextParagraf(
                      title: 'NISN', value: widget.sumbanganSiswaModel.nisn),
                  TextParagraf(
                      title: 'Kode Buku',
                      value: widget.sumbanganSiswaModel.bookCode),
                  TextParagraf(
                      title: 'Nama Buku',
                      value: widget.sumbanganSiswaModel.bookName),
                  TextParagraf(
                      title: 'Jumlah Buku',
                      value: widget.sumbanganSiswaModel.numberOfBook),
                  TextParagraf(
                      title: 'Pengarang',
                      value: widget.sumbanganSiswaModel.bookCreator),
                  TextParagraf(
                      title: 'Tahun Buku',
                      value: widget.sumbanganSiswaModel.bookYear),
