...
class DetailPeminjamanBukuPegawai extends StatefulWidget {
  const DetailPeminjamanBukuPegawai(
  ...
  @override
  State<DetailPeminjamanBukuPegawai> createState() =>
      _DetailPeminjamanBukuPegawaiState();
}

class _DetailPeminjamanBukuPegawaiState
    extends State<DetailPeminjamanBukuPegawai> {
              ...
              child: Column(
                children: [
                  ...
                  ListDetailBuku(
                      ...
                      value: widget.pengajuanBukuPegawaiPerpusModel.toDate
                          .toIso8601String()),
                ],
              ),
            ),
