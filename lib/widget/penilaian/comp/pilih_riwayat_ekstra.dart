...
import 'package:siakad_app/widget/penilaian/comp/riwayat_penilaian_ekstra.dart';

import '../../../constan.dart';
import '../../../services/auth_service.dart';
import 'package:http/http.dart' as http;

class PilihRiwayatEkstraPembina extends StatefulWidget {
  const PilihRiwayatEkstraPembina(
      {Key? key,
      required this.nameekstraPembina,
      required this.idEkstraPembina})
      : super(key: key);

  final String nameekstraPembina;
  final int idEkstraPembina;

  @override
  State<PilihRiwayatEkstraPembina> createState() =>
      PilihRiwayatEkstraPembinaState();
}

class PilihRiwayatEkstraPembinaState extends State<PilihRiwayatEkstraPembina> {
