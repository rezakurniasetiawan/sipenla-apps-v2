...
import 'package:siakad_app/widget/penilaian/comp/input_penilaian.dart';
import 'package:http/http.dart' as http;

class PilihPenilaian extends StatefulWidget {
  const PilihPenilaian({Key? key}) : super(key: key);

  @override
  State<PilihPenilaian> createState() => _PilihPenilaianState();
}

class _PilihPenilaianState extends State<PilihPenilaian> {
  var valueSemester;
  var valueMapel;
  var valueKelas;
  var valuePenilaian;
                ...
                onTap: () {
                  if (valueSemester == null) {
                    ...
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => InputPenilaian(
                                  idClass: valueKelas,
                                  idMapel: valueMapel,
                                  idPenilaian: valuePenilaian,
                                  idSemesteer: valueSemester,
                                  idAcademik: valueTahunAkademikk,
                                )));
                  }
                },
                child: Center(
