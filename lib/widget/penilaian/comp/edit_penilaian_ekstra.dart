...
class EditPenilaianEkstra extends StatefulWidget {
  const EditPenilaianEkstra(
      {Key? key,
      required this.akademik,
      required this.semester,
      required this.ekstraName,
      required this.name,
      required this.nisn,
      required this.nilai,
  ...
  final String akademik, semester, ekstraName, name, nisn, nilai, idPenilaian;

  @override
  State<EditPenilaianEkstra> createState() => _EditPenilaianEkstraState();
}

class _EditPenilaianEkstraState extends State<EditPenilaianEkstra> {
  ...
  void fungsiUpdateNilai(String idPen) async {
    ...
    ApiResponse response =
        await updateNilaiEkstraSiswa(penilaianId: idPen, nilai: nilai.text);
