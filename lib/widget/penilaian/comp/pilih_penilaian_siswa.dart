...
import 'package:siakad_app/widget/penilaian/comp/riwayat_penilaian_siswa.dart';
import 'package:http/http.dart' as http;

class PilihPenilaianSiswa extends StatefulWidget {
  const PilihPenilaianSiswa({Key? key}) : super(key: key);

  @override
  State<PilihPenilaianSiswa> createState() => _PilihPenilaianSiswaState();
}

class _PilihPenilaianSiswaState extends State<PilihPenilaianSiswa> {
              ...
              onTap: () {
                if (valueSemester == null) {
                  ...
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => RiwayatPenilaianSiswa(
