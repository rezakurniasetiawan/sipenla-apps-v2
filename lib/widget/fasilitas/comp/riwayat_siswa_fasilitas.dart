...
class RiwayatSiswaFasilitas extends StatefulWidget {
  const RiwayatSiswaFasilitas({Key? key}) : super(key: key);

  @override
  State<RiwayatSiswaFasilitas> createState() => _RiwayatSiswaFasilitasState();
}

class _RiwayatSiswaFasilitasState extends State<RiwayatSiswaFasilitas> {
  bool _loading = true;
  List<dynamic> _RiwayatList = [];

  Future<void> fungsiGetRiwayat() async {
    ApiResponse response = await getRiwayatSiswaFasilitas();
        ...
        body: _loading
            ...
            : ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  RiwayatSiswaFasilitasModel2 riwayatSiswaFasilitasModel =
                      _RiwayatList[index];
                  return Padding(
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            ...
                            Expanded(
                              child: Text(
                                riwayatSiswaFasilitasModel.firstName +
                                    ' ' +
                                    riwayatSiswaFasilitasModel.lastName,
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Expanded(
                              child: Text(
                                riwayatSiswaFasilitasModel.nisn,
                                style: const TextStyle(
                                  fontSize: 12,
                                  fontWeight: FontWeight.w400,
                                  fontFamily: 'Poppins',
