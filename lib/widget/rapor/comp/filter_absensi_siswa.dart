...
import 'data_absensi_siswa.dart';

class FilterAbsensiSiswa extends StatefulWidget {
  const FilterAbsensiSiswa(
  ...
  @override
  State<FilterAbsensiSiswa> createState() => _FilterAbsensiSiswaState();
}

class _FilterAbsensiSiswaState extends State<FilterAbsensiSiswa> {
  ...
  void initState() {
    ...
    print('anjing ${widget.nameSiswa}');
    print(widget.nisnSIswa);
  }
              ...
              onTap: () {
                if (valueSemester == null) {
                  ...
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => DataAbsensiSiswa(
