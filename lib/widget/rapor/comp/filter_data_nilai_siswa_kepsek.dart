...
import '../../../constan.dart';
import 'konfirmasi_nilai_siswa_kepsek.dart';

class FilterDataNilaiSiswaKepsek extends StatefulWidget {
  const FilterDataNilaiSiswaKepsek({Key? key}) : super(key: key);

  @override
  State<FilterDataNilaiSiswaKepsek> createState() =>
      _FilterDataNilaiSiswaKepsekState();
}

class _FilterDataNilaiSiswaKepsekState
    extends State<FilterDataNilaiSiswaKepsek> {
              ...
              onTap: () {
                if (valueSemester == null) {
                  ...
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => KonfirmasiNilaiSiswaKepsek(
