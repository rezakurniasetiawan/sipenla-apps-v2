...
import 'package:siakad_app/widget/data-user/riwayat_siswa_byweek.dart';

class ListWeekStatistikSiswa extends StatefulWidget {
  const ListWeekStatistikSiswa({Key? key, required this.idStudent})
      : super(key: key);

  final String idStudent;

  @override
  State<ListWeekStatistikSiswa> createState() => _ListWeekStatistikSiswaState();
}

class _ListWeekStatistikSiswaState extends State<ListWeekStatistikSiswa> {
  String? attend, absence, sick, izin;
  bool _loading = true;
  List<dynamic> _weekList = [];
  Future<void> fungsiGetWeekAbsensi() async {
    ApiResponse response =
        await getWeekAbsensibyIdSiswa(idStudent: widget.idStudent);
  ...
  void statistik() async {
    ...
    final response = await http.get(
        Uri.parse(baseURL + '/api/data/statisticmapel/${widget.idStudent}'),
        headers: {
